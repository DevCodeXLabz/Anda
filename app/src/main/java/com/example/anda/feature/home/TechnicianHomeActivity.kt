...
import com.example.anda.databinding.ActivityTechnicianHomeBinding
...
/**
 * Home screen for the Técnico SST profile.
 *
 * Provides access to ALL document types organised in thematic sections:
 * Medicina do Trabalho, Documentos SST, Laudos NR, Laudos Especializados,
 * Programas SST, and Ferramentas.
 */
class TechnicianHomeActivity : SecuredHomeActivity() {

    private lateinit var binding: ActivityTechnicianHomeBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        DocumentLocalRepository.initialize(this)

        binding = ActivityTechnicianHomeBinding.inflate(layoutInflater)
        ...
        binding.openServiceRequestsButton.setOnClickListener {
            startActivity(
                Intent(this, ServiceRequestsActivity::class.java)
    ...
    private fun renderPersonalizedHeader() {
        ...
        binding.subtitleText.text = if (name.isNotBlank()) {
            ...
            getString(R.string.technician_home_subtitle)
        }
    }
